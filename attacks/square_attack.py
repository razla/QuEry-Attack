...
def square_attack(init_model, min_ball, max_ball, x_test, i, square_adv, n_iter):
    ...
    square_attack = SquareAttack(estimator=square_classifier, norm='inf', max_iter=n_iter, p_init=0.05)
